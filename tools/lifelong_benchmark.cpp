...
namespace
{
  ...
  void write_csv_row(std::ostream& out, const LifelongSimulationMetrics& m)
  {
    out << m.map_name << "," << m.num_agents << "," << m.horizon << ","
        ...
        << m.planner_failure_count << "," << m.planner_snapshot_infeasible_count
        ...
        << "," << m.total_simulation_runtime << "," << m.average_agent_idle_time
        << "," << m.average_agent_loaded_time << ","
        ...
        << m.assignment_row_cache_requests << "," << m.assignment_row_cache_hits
                       ...
                       const LifelongSimulationMetrics& metrics)
  {
    ...
    out << "timestep,should_replan,event_happened,plan_finished,"
           "previous_planner_failed,idle_unloaded_with_pending,snapshot_"
           "feasible,"
           ...
           "max_agents_per_target,duplicate_target_slots,agents_carrying_two_"
           "tasks,"
           ...
           "average_priority_offset_now,max_priority_offset_now,"
           "max_priority_offset_agent_id,"
    ...
    for (const auto& r : metrics.planner_trace_records) {
      out << r.timestep << "," << r.should_replan << "," << r.event_happened
          ...
          << "," << r.planning_runtime_ms << "," << r.assignment_time_ms << ","
          ...
          << r.loaded_delivery_goal_options << "," << r.loaded_wait_goal_options
          ...
          << r.average_target_region_agent_count << ","
          << r.max_target_region_agent_count << ","
          << r.average_target_region_loaded_agent_count << ","
          << r.max_target_region_loaded_agent_count << ","
          << r.average_target_region_loaded_waiting_count << ","
          << r.max_target_region_loaded_waiting_count << ","
          << r.average_target_region_loaded_stopped_count << ","
          << r.max_target_region_loaded_stopped_count << ","
          << r.average_carried_tasks_now << "," << r.max_carried_tasks_now
          << "," << r.average_loaded_distance_now << ","
          << r.max_loaded_distance_now << "," << r.average_priority_offset_now
          << "," << r.max_priority_offset_now << ","
          << r.max_priority_offset_agent_id << "," << r.hl_loop_iterations
          << "," << r.hl_nodes_created << "," << r.hl_nodes_explored << ","
          << r.hl_reinsertions << "," << r.hl_duplicate_configs << ","
          << r.open_max_size << "," << r.constraints_popped << ","
          << r.constraints_generated << "," << r.constraint_failures << ","
          << r.pibt_calls << "," << r.pibt_failures << "," << r.pibt_recursions
          ...
          << r.service_satisfied_agents << "," << r.service_satisfied_pickups
                           ...
                           const std::string& output_path)
  {
    ...
    out << "  pickup_while_loaded_count: " << metrics.pickup_while_loaded_count
        << "\n";
    out << "  delivery_events: " << metrics.delivery_events << "\n";
    out << "  assignment_row_cache_requests: "
        << metrics.assignment_row_cache_requests << "\n";
    out << "  assignment_row_cache_hits: " << metrics.assignment_row_cache_hits
        << "\n";
...
int main(int argc, char** argv)
{
  ...
  std::cout << "pickup_service_duration=" << config.pickup_service_duration
            << "\n";
  ...
  std::cout << "pickup_while_loaded_count=" << metrics.pickup_while_loaded_count
            << "\n";
  ...
  std::cout << "assignment_row_cache_requests="
            << metrics.assignment_row_cache_requests << "\n";
  std::cout << "assignment_row_cache_hits=" << metrics.assignment_row_cache_hits
            << "\n";
  ...
  std::cout << "total_planner_runtime=" << metrics.total_planner_runtime
            << "\n";
  std::cout << "total_assignment_runtime=" << metrics.total_assignment_runtime
            << "\n";
  ...
  if (metrics.first_empty_loaded_agents >= 0) {
    ...
    std::cout << "first_empty_idle_agents=" << metrics.first_empty_idle_agents
              << "\n";
